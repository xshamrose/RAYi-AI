...
const Home = () => {
 ...
 const handleClickCardThree = () => {
  navigate("/facedetecter", {
    state: {
      title: "Face Detector",
      subtitle: "Detect faces with our advanced facial recognition technology. Get accurate results and timely analysis for better outcomes.",
    },
  });
};
