...
navigate("/chatbox")
  ...
  return (
    <>    <div>
      <div>
      <Header title={"Breast cancer detecter"} subtitle={"Detect breast cancer early with our advanced screening technology. Get accurate results and timely treatment for better outcomes."}
          />
