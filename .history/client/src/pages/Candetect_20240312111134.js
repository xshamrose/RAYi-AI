     ...
     if (title === "Breast Cancer Detector") {
      ...
      reader.onloadend = () => {
        ...
        axios
          ...
          .then((response) => {
            setLoading(false);
            // Assuming the response is a JSON object with a base64_image key
          
            // You can now use base64Image as needed, for example, display it
            setResponseData(base64Image);
          })
          .catch((error) => {
            setLoading(false);
            setErrorMessage("Failed to submit. Please try again.");
              ...
              {loading ? (
                ...
                <div>
                 {typeof responseData === 'string' ? (
                    ...
                    <div className="idcard-border-top">
                    </div>
                    <div className="img">
