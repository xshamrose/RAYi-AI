...
console.log(totalCount)
 ...
 const getModelContent = () => {
  if (title === "Breast Cancer Detector") {
     return (
       <div>
         <p>Overview: Our breast cancer detection model utilizes state-of-the-art deep learning techniques to analyze histopathological images of breast tissue and provide accurate predictions regarding the presence or absence of cancerous cells.</p>
