...
if (title === "Breast Cancer Detector") {
  return (
     <div className="contentbox-below">
       <p className="overview-text">Overview: Our breast cancer detection model utilizes state-of-the-art deep learning techniques to analyze histopathological images of breast tissue and provide accurate predictions regarding the presence or absence of cancerous cells.</p>
  ...
  return (
     <div className="contentbox-below">
       ...
       <p className="how-it-works-text">Download Now:
  ...
  return (
     <div className="contentbox-below">
       <p className="overview-text">Overview: <p>Our pipe counting model utilizes advanced computer vision algorithms to accurately detect and count pipes within images.</p></p>
